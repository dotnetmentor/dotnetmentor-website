...
- **Consulting** — IT architecture and software development with .NET, front-end, and open source expertise.
- **Mentorship** — Targeted or long-term mentorship to strengthen existing development teams.
- **Training** — Custom training on project structure, testing, CI/CD, and team onboarding.
- **Product Development** — End-to-end product creation, maintenance, and evolution.
